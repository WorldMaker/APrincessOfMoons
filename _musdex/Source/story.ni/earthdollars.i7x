...
[one of]All the Earthdollars seem so similar[or]This is definitely an 
Earthdollars[or]Good old, comfortable Earthdollars[at random]. The place
 has a constant flow of traffic, given the impression of alternating 
bursts of packed and busy followed by quiet and contemplative. At the 
moment [one of]it seems crowded and tense[or]it's in a bit of a lull[at 
random]."
¶
...
¶
¶The Earthdollars store door is an open door. It is outside of 
Earthdollars. It is not openable. The initial appearance of the 
Earthdollars store door is "A door leads [direction of the item 
described from the location] to [if other side of the item described is 
Earthdollars]Earthdollars[otherwise if other side of the item described 
is in Luna]the rest of Luna[otherwise]the rest of the moon you are 
currently on[end if]." 
¶
¶